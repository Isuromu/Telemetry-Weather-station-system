...
- Профиль `TUF-2000M + TS-2 Ultrasonic Flow Meter`:
  ...
  - оба варианта порядка слов REAL4 без автоматического угадывания.
...
4. В `Parsed values` сравните оба варианта REAL4. Правильный порядок должен
   совпасть с M01/M91, а внутренний диаметр должен быть около `57 mm`.
...
настройки прибора и не выбирает порядок слов REAL4 без аппаратного сравнения.
