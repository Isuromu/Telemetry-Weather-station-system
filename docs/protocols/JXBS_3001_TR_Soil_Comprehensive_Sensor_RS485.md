# JXBS-3001-TR Soil Comprehensive Sensor (RS485)

Source: `JXBS-3001-TR 485 土壤综合传感器英文版.pdf`

## 1) Overview
- **Purpose / measurements:** Soil temperature, moisture, conductivity, pH, and N/P/K (7 parameters).
...
**Notes:** Manual includes multiple read examples; register addresses match common JXBS soil family.
...
|---|---:|---:|---|---|
| Soil moisture | 0 | 100 | % | raw u16 in 0.1% |
| Soil temperature | -40 | 80 | °C | raw s16 in 0.1°C |
| Soil EC | 0 | 10000 | µS/cm | raw u16 |
| Soil pH | 3 | 9 | pH | raw u16 in 0.01 pH |
| N/P/K | 0 | UNCERTAIN | mg/kg | explicit max not extracted; apply plausibility filter |
