# JXBS-3001-O3 Ozone Sensor (RS485)

Source: `RS485-O3.pdf`

## 1) Overview
- **Purpose / measurements:** Ozone concentration (plus humidity and temperature registers in the same device family).
...
**Notes:** Register table explicitly lists ozone at 0x0006 with unit 0.01 ppm.
...
| 0x0006 | Ozone | 0x03 | u16 | BE | /100 | ppm | sensor-dependent | Unit 0.01 ppm; 189 -> 1.89 ppm |
...
### Read ozone concentration (1 register)
...
byte 1 : 0x03
byte 2 : 0x02
bytes 3..4 : ozoneRaw u16 BE
bytes 5..6 : CRC (Lo, Hi)
```

**Parsing formulas:**

ozone_ppm = u16(ozoneRaw) / 100.0

**Worked example (from manual if available):**

Example: 0x00BD=189 → 1.89 ppm.
...
|---|---:|---:|---|---|
| O3 | 0 | 100 | ppm | manual lists 0–10 ppm or 0–100 ppm variants; driver should configure expected max |

### Rate-of-change / plausibility (optional but recommended)
- **O3:** Any value > configured max+10% is a fault
