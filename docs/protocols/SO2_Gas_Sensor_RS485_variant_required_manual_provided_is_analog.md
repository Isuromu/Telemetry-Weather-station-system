# SO2 Gas Sensor (RS485 variant required, manual provided is analog)

Source: `SO2 product manual _20240628.pdf`

## 1) Overview
- **Purpose / measurements:** Sulfur dioxide concentration (SO2).
...
**Notes:** The uploaded manual content is for analog outputs and does not include Modbus RTU details. You need the RS485 Modbus manual for the RS485 SO2 sensor model.

Scale/range note from the provided analog PDF:
- The PDF lists SO2 probe ranges `0-20 ppm` and `0-2000 ppm`.
...
|---|---:|---:|---|---|
| SO2 | 0 | 20 or 2000 | ppm | analog doc lists both probe variants; configure expected max for the actual shield/sensor |
