# Basic Assembly Accessories for Shutter Box (non-sensor item)

Source: `(No protocol; accessories only)`

## 1) Overview
- **Purpose / measurements:** Mechanical/electrical accessories for PM sensor shutter box.
...
**Notes:** Not a sensor and has no Modbus protocol.
