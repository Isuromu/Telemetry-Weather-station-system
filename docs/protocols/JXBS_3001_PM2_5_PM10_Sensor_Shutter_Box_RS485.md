# JXBS-3001 PM2.5/PM10 Sensor (Shutter Box, RS485)

Source: `JXBS-3001-PM2.5 10 -RS485 - Shutter Box Type.doc (converted to txt)`

## 1) Overview
- **Purpose / measurements:** PM2.5 and PM10 concentrations.
...
**Notes:** Register map and example query are present.

## 3) Register map
| Register (hex) | Name | Function | Data Type | Endianness | Scale | Units | Range | Notes |
|---:|---|---:|---|---|---:|---|---|---|
| 0x0004 | PM2.5 | 0x03 | u16 | BE | 1 | µg/m³ | sensor-dependent | 1 µg/m³ per LSB |
| 0x0009 | PM10 | 0x03 | u16 | BE | 1 | µg/m³ | sensor-dependent | 1 µg/m³ per LSB |
...
### Read PM2.5 (1 register)

**Request (WITHOUT CRC):** `01 03 00 04 00 01`
...
Manual provides query/response pattern; value example not fully extracted.

### Read PM10 (1 register)

**Request (WITHOUT CRC):** `01 03 00 09 00 01`
...
Register 0x0009 is documented for PM10.
...
|---|---:|---:|---|---|
| PM2.5 | 0 | 300 | µg/m³ | raw u16 1 µg/m³ |
| PM10 | 0 | 300 | µg/m³ | raw u16 1 µg/m³ |
