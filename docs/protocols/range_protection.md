...
| `JXBS_3001_NO2_Nitrogen_Dioxide_Sensor_RS485_variant_required_manual_provided_is_analog.md` | NO2: 0..20 or 0..2000 ppm | NO2: analog doc lists both probe variants; 20 ppm has 0.01 ppm resolution, 2000 ppm has 0.1 ppm resolution; configure expected max for the actual shield/sensor |
...
| `Water_Conductivity_Controller_Probe_RS485.md` | Water temperature: -10..80 C; Conductivity: 0..configured max uS/cm | Conductivity is raw u32 from registers 0x0002/0x0003; K=1 example uses raw / 100.0, but scale and max must match the probe/controller range |
...
| `SO2_Gas_Sensor_RS485_variant_required_manual_provided_is_analog.md` | SO2: 0..20 or 0..2000 ppm | SO2: analog doc lists both probe variants; 20 ppm has 0.01 ppm resolution, 2000 ppm has 0.1 ppm resolution; configure expected max for the actual shield/sensor |
...
| `Water_Conductivity_Sensor_RS485_project_item.md` | Water temperature: -10..80 C; Conductivity: 0..configured max uS/cm | Same protocol as water conductivity controller + probe; confirm the hardware is RS485 transmitter/controller assembly, not bare probe only |
