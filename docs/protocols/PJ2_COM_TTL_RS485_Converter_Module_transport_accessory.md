# PJ2-COM TTL-RS485 Converter Module (transport accessory)

Source: `pj2-com-ttl-rs485-manual-2021-05-07-2706.pdf`

## 1) Overview
- **Purpose / measurements:** TTL UART to RS485 transceiver module used as interface hardware.

## 2) Electrical & RS485 settings
- **Interface / protocol:** Not Modbus by itself; it transports UART bytes over RS485. Config depends on host MCU UART settings.
- **Serial:** Host-controlledHost-controlledHost-controlled (data/parity/stop)
- **Baud:** Host UART-controlled
- **Default Modbus address:** N/A
- **Supported address range:** N/A
- **Wiring notes:** TTL side: VCC, GND, TXD, RXD; RS485 side: A/B; DE/RE behavior per module wiring.

**Notes:** Useful for bench testing sensors with Arduino/USB-UART. No register map; it is transport-only.
