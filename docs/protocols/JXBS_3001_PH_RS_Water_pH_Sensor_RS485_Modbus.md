# JXBS-3001-PH-RS Water pH Sensor (RS485 Modbus)

Source: `JXBS-3001-PH RS485 Liquid PH Sensor- V2.pdf`

## 1) Overview
- **Purpose / measurements:** Water pH and temperature.
...
**Notes:** Register map is explicitly listed.
...
| 0x0002 | pH | 0x03 | u16 | BE | /100 | pH | 0..14 | 0.01 pH |
...
Example: raw 0x00BD=189 → pH 1.89.

### Read temperature (1 register)

**Request (WITHOUT CRC):** `01 03 00 01 00 01`
...
byte 1 : 0x03
byte 2 : 0x02
bytes 3..4 : tempRaw s16 BE
bytes 5..6 : CRC
```

**Parsing formulas:**

temperature_c = int16(tempRaw) / 10.0

**Worked example (from manual if available):**

Temperature example depends on actual fluid; verify on hardware.
...
|---|---:|---:|---|---|
| pH | 0 | 14 | pH | raw u16 in 0.01 pH → 0..1400 |
| Water temperature | UNCERTAIN | UNCERTAIN | °C | manual text extraction didn’t expose numeric limits; use a conservative clamp -10..60°C unless your process needs wider |
