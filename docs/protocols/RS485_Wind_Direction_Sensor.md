...
## 1) Overview
- **Purpose / measurements:** Wind direction angle (degrees).
...
**Notes:** Manual includes read example at register 0x0000.

## 3) Register map
| Register (hex) | Name | Function | Data Type | Endianness | Scale | Units | Range | Notes |
|---:|---|---:|---|---|---:|---|---|---|
| 0x0000 | Wind direction | 0x03 | u16 | BE | 1 | degrees | 0..360 | Angle |
...
### Read wind direction (1 register)
...
byte 1 : 0x03
byte 2 : 0x02
bytes 3..4 : direction u16 BE
bytes 5..6 : CRC (Lo, Hi)
```

**Parsing formulas:**

direction_deg = u16(raw)

**Worked example (from manual if available):**

Example: raw 0x0131 = 305 → 305°.
...
|---|---:|---:|---|---|
| Wind direction | 0 | 360 | deg | raw u16 degrees |
