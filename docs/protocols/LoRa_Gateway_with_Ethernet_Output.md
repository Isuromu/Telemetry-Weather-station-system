# LoRa Gateway with Ethernet Output

Source: `(No manual provided in uploads)`

## 1) Overview
- **Purpose / measurements:** LoRa network gateway to Ethernet/IP backend.

## 2) Electrical & RS485 settings
- **Interface / protocol:** Ethernet/IP, not RS485/Modbus.
- **Serial:** N/AN/AN/A (data/parity/stop)
- **Baud:** N/A
- **Default Modbus address:** N/A
- **Supported address range:** N/A
- **Wiring notes:** Ethernet + power + LoRa antenna.

**Notes:** No gateway manual provided. Provide model number and protocol/API docs.
