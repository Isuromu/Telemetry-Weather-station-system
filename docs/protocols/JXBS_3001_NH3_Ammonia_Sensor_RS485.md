# JXBS-3001-NH3 Ammonia Sensor (RS485)

Source: `RS485-NH3.doc (converted to txt)`

## 1) Overview
- **Purpose / measurements:** Ammonia concentration (NH3) + humidity + temperature.
...
**Notes:** Converted from Word doc; register table is present.
...
| 0x0006 | Ammonia (NH3) | 0x03 | u16 | BE | /10 | ppm | sensor-dependent | Unit 0.1 ppm |
...
### Read ammonia concentration (1 register)
...
byte 1 : 0x03
byte 2 : 0x02
bytes 3..4 : nh3Raw u16 BE
bytes 5..6 : CRC (Lo, Hi)
```

**Parsing formulas:**

nh3_ppm = u16(nh3Raw)/10.0
...
|---|---:|---:|---|---|
| NH3 | 0 | 5000 | ppm | manual lists 0–100/1000/5000 ppm variants; driver should configure expected max |
