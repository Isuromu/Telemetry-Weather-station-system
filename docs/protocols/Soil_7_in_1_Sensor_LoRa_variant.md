# Soil 7-in-1 Sensor (LoRa variant)

Source: `(No manual provided in uploads)`

## 1) Overview
- **Purpose / measurements:** Soil multi-parameter (7-in-1) over LoRa transport (per project bill of materials).

## 2) Electrical & RS485 settings
- **Interface / protocol:** LoRa (not RS485/Modbus).
- **Serial:** N/AN/AN/A (data/parity/stop)
- **Baud:** N/A
- **Default Modbus address:** N/A
- **Supported address range:** N/A
- **Wiring notes:** Depends on LoRa node hardware; not an RS485 bus device.

**Notes:** No protocol document in the provided uploads. If you need a protocol source-of-truth, provide the LoRa payload spec or firmware/protocol doc.
...
|---|---:|---:|---|---|
| Soil params | UNCERTAIN | UNCERTAIN |  | LoRa transport; apply the same physical bounds as the RS485 soil sensor model you actually use |
...
## 7) Examples & pitfalls
- Not RS485/Modbus. Do not treat as Modbus device on RS485 bus.
