# RS485 Photosynthetically Active Radiation (PAR) Sensor

Source: `RS485_Photosynthetically_active_radiation_Sensor_User_Manual.pdf`

## 1) Overview
- **Purpose / measurements:** Photosynthetically active radiation (PAR).
...
**Notes:** Manual provides read at register 0x0006.

## 3) Register map
| Register (hex) | Name | Function | Data Type | Endianness | Scale | Units | Range | Notes |
|---:|---|---:|---|---|---:|---|---|---|
| 0x0006 | PAR value | 0x03 | u16 | BE | 1 | (sensor-defined) | sensor-dependent | Manual labels as 1 W/m² in some families; confirm unit for your exact probe. |
...
byte 1 : 0x03
byte 2 : 0x02
bytes 3..4 : parRaw u16 BE
bytes 5..6 : CRC (Lo, Hi)
```

**Parsing formulas:**

par = u16(parRaw)  (apply unit conversion only if your manual specifies it)

**Worked example (from manual if available):**

Example: raw 0x0047 = 71.
...
|---|---:|---:|---|---|
| PAR (as reported by sensor) | 0 | 2000 | W/m² | raw u16, resolution 1 W/m² |
